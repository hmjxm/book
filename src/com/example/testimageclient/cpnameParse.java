...
public class cpnameParse {
	private static final String urlPath = "http://10.169.162.122:8080/cbb+book/getbookServlet";  
	public static List<book> getcpname(String btype) throws Exception {  
		HttpClient hc=new DefaultHttpClient();
		HttpPost hp=new HttpPost(urlPath);
		NameValuePair param1=new BasicNameValuePair("btype",btype);
