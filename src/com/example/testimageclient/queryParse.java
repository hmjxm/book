...
public class queryParse {
	private static String url="http://10.169.162.122:8080/cbb+book/queryServlet";
	
	public static String doPost(String bid,String uname) throws ClientProtocolException, IOException
	{
