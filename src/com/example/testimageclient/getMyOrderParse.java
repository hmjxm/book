...
public class getMyOrderParse {
	private static String url="http://10.169.162.122:8080/cbb+book/getMyOrderServlet";
		...
		try {
			...
			if(response.getStatusLine().getStatusCode()==HttpStatus.SC_OK)
			{
		        ...
		        for (int i = 0; i < array.length(); i++) {  
		            ...
		            mlists.add(new book(orderid,ordertime,lper,ltel,loc));   
		        }
