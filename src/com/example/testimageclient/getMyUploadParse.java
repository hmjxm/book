...
public class getMyUploadParse {
	private static String url="http://10.169.162.122:8080/cbb+book/getMyUploadServlet";
	
	public static List<book> doPost(String uname) throws ClientProtocolException, IOException, JSONException
	{
		...
		try {
			...
			if(response.getStatusLine().getStatusCode()==HttpStatus.SC_OK)
			{
		        ...
		        for (int i = 0; i < array.length(); i++) {  
		            ...
		            mlists.add(new book(bid,bname,bprice,bintro,bpic,btime,bstate));   
		        }
