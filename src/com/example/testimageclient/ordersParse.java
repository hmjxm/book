...
public class ordersParse {
	private static String url="http://10.169.162.122:8080/cbb+book/ordersServlet";
	static String result="";
	public static String doPost(String orderid,String uname,String ordertime,String lper,String ltel,String loc) throws ClientProtocolException, IOException
	{
		HttpClient hc=new DefaultHttpClient();
		HttpPost hp=new HttpPost(url);
		NameValuePair param1=new BasicNameValuePair("orderid",orderid);
		NameValuePair param2=new BasicNameValuePair("uname",uname);
