...
public class orderDetailActivity1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final List<HashMap<String,Object>> blist = new ArrayList<HashMap<String, Object>>();
		String bname=intent.getExtras().getString("bname");
		Double bprice=intent.getExtras().getDouble("bprice");
		String bpic=intent.getExtras().getString("bpic");
		...
		orderDetailAdapter orderDetailAdapter = new orderDetailAdapter(orderDetailActivity1.this,blist); //创建适配器  
