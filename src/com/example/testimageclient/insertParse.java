...
public class insertParse {
	private static String url="http://10.169.162.122:8080/cbb+book/insertServlet";
	
	public static String doPost(String uname,String pwd,String touxiang) throws ClientProtocolException, IOException
	{
		HttpClient hc=new DefaultHttpClient();
		HttpPost hp=new HttpPost(url);
		NameValuePair param1=new BasicNameValuePair("uname",uname);
		NameValuePair param2=new BasicNameValuePair("pwd",pwd);
		NameValuePair param3=new BasicNameValuePair("touxiang",touxiang);
