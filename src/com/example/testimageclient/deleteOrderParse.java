...
public class deleteOrderParse {
	private static String url="http://10.169.162.122:8080/cbb+book/deleteOrderServlet";
	
	public static String doPost(String orderid) throws ClientProtocolException, IOException
	{
